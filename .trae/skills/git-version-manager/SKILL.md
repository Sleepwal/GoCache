...
### 版本管理
- 如果 README.md 中没有版本号，初始版本默认为 `v0.1.0`
- 如果 Tag 已存在，会提示冲突，不会强制覆盖

### 提交策略
- **按类型分开提交**：功能提交、修复提交、文档提交等各自独立，不要一次性提交
- **只执行 git commit，不执行 git push**。版本更新后等待用户确认再推送

### 操作确认
- 更新前会显示变更预览，用户可以取消
- 所有操作都会记录在 Git history 中
